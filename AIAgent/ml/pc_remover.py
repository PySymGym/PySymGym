...
def remove_path_condition_root(heterodata: HeteroData) -> HeteroData:
    ...
    # print(len(path_condition_vertex))
    # print(path_condition_vertex)
    ...
    if pathcondvertex_to_pathcondvertex.size > 0:
        print("max el: ", np.max(pathcondvertex_to_pathcondvertex))
        print("min el: ", np.min(pathcondvertex_to_pathcondvertex))
    ...
    if len(edge_index_pc_pc) > 0:
        print("max el: ", np.max(edge_index_pc_pc))
        print("min el: ", np.min(edge_index_pc_pc))
