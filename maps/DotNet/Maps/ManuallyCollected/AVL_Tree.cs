...
public class TreeNode<T> : ICollection<T>, IList<T> where T : IComparable<T>
{
    ...
    public int IndexOf(T item)
    {
        ...
        else if (this.RightHand == null) return -1;
...
public class Tree<T> : ICollection<T>, IList<T> where T : IComparable<T>
{
    ...
    public bool Contains(T item)
    {
        return this.RootNode == null ? false : this.RootNode.Contains(item);
    }
    ...
    public int Count
    {
        get { return this.RootNode.Count; }
    }
    ...
    public bool Remove(T item)
    {
        return this.RootNode == null ? false : this.RootNode.Remove(item);
    }
    ...
    public int IndexOf(T item)
    {
        return this.RootNode != null ? this.RootNode.IndexOf(item) : -1;
    }
    ...
    public void RemoveAt(int index)
    {
        if (this.RootNode != null) this.RootNode.RemoveAt(index);
    }
